            ...
            <div style="margin-top: 50px">
                <div class="row">
                    <div class="row input-field col s12 m4">
                        <label class="active white-text" for="facultad">Facultad</label>
                    ...
                    <div id="cajalicen" class="row input-field col s12 m4 white-text oculto">
                    ...
                    <div id="cajasemestre" class="input-field col s12 m4 white-text oculto">
